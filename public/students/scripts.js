...
var vm = new Vue({
	...
	methods: {
		...
		fetchUser: function () {
			this.$http.get('/api/students/', function (data) {
				this.$set('users', data)
			})
		},
		...
		RemoveUser: function (id) {
			...
			if(ConfirmBox) this.$http.delete('/api/students/' + id)
		...
		EditUser: function (id) {
			...
			this.$http.patch('/api/students/' + id, user, function (data) {
				console.log(data)
			})
		...
		ShowUser: function (id) {
			...
			this.$http.get('/api/students/' + id, function (data) {
		...
		AddNewUser: function () {
			...
			// Send post request
			this.$http.post('/api/students/', user)
